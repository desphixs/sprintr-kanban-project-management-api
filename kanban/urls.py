...
# Import our ProjectListAPIView and ProjectDetailAPIView classes from views.py in the current folder
from kanban.views import ProjectListAPIView, ProjectDetailAPIView
